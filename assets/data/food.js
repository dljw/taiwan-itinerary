...
window.TRIP.foodDirectory = [
  ...
  { day: 5, date: { en: "Wed 9 Sep", zh: "9/9 周三" }, meal: "Breakfast",
    name: { en: "Fu Hang Soy Milk 阜杭豆漿", zh: "阜杭豆浆" },
    rating: "4.1", cost: 120,
    maps: "https://www.google.com/maps/search/?api=1&query=阜杭豆漿",
    known: { en: "Savoury soy milk, thick shaobing, fresh-fried youtiao — the queue is legendary, so aim for 08:00. <b>Closed Mondays</b> (today's Wednesday, so no problem).",
             zh: "咸豆浆、厚烧饼、现炸油条——排队出了名，八点前到最好。<b>周一公休</b>（今天周三，没问题）。" } },
  ...
  { day: 5, date: { en: "Wed 9 Sep", zh: "9/9 周三" }, meal: "Tea / dinner",
  ...
  { day: 4, date: { en: "Tue 8 Sep", zh: "9/8 周二" }, meal: "Afternoon snack",
...
window.TRIP.budgetNotes = {
  ...
  excluded: [
    ...
    { en: "<b>The six mid-bus bookings</b> — Day 1 morning transfer, Day 3 Yilan, Day 4 Xiao Wulai + Daxi, Day 5 Jiufen–Shifen package, Day 6 Shiding half-day, Day 7 airport send-off. Charged per vehicle, so they sit outside this table. About NT$45,000–55,000 for the week. See the <b>Transport page</b>",
      zh: "<b>六段中巴</b>——第1天上午接机、第3天宜兰、第4天小乌来加大溪、第5天九份十分套装、第6天石碇半天、第7天送机。以车计费，所以不列在这张表里。全周约NT$45,000–55,000。详见<b>交通页</b>" },
    { en: "<b>Shopping</b> — Daxi tofu and woodwork on Day 4, Ximending on Day 6, and the Dihua Street gift run on the last day",
      zh: "<b>购物</b>——第4天大溪的豆干与木工艺品、第6天的西门町，以及最后一天迪化街的伴手礼" },
