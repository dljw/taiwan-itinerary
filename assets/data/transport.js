...
window.TRIP.transport = {
  ...
  days: [
    ...
    { n: 3, date: { en: "Mon 7 Sep", zh: "9月7日 周一" }, mode: { en: "Taipei mid-bus", zh: "台北中巴" },
      ...
      route: { en: "Hotel 08:30 → Lanyang Kingdom, Zhuangwei → jar chicken or seafood lunch → Qingshui Geothermal Park until ~16:00 → hotel ~18:15", zh: "饭店08:30 → 壮围兰阳动植物王国 → 甕缸鸡或海鲜午餐 → 清水地热公园至约16:00 → 饭店约18:15" },
      note: { en: "<b>Do not split this across Kamalan and taxis</b> — Zhuangwei is on the coast and Qingshui is in the western mountains, a forty-to-fifty-minute crossing of the plain, and the last lane at Qingshui may not take a 中巴. Book a Taipei 中巴 that waits; if 501巷 is too narrow, wait at 長埤湖. Same operator as the other mid-bus days. A named typhoon cancels the tunnel; stay in Taipei.",
              zh: "<b>不要拆成葛玛兰加计程车</b>——壮围在海边、清水在西边山里，横过平原要四十分钟到五十分钟，清水最后那段路中巴还可能进不去。请订会等候的台北中巴；501巷太窄就停長埤湖。可与其他中巴同一家。有命名的台风就取消隧道；留台北。" } },
  ...
  tips: [
    ...
    { en: "<b>Change about S$100 per person in Singapore</b> — that is NT$2,500 in small notes. Old streets, night markets, lanterns and the Yilan jar-chicken lunch are still cash. The EasyCard covers Day 2 and the Thursday afternoon MRT.",
      zh: "<b>出发前在新加坡每人约换 S$100</b>——即 NT$2,500 小钞。老街、夜市、天灯和宜兰甕缸鸡仍收现金。悠游卡够付第2天和周四下午的捷运。" }
  ],
